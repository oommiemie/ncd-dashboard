...
import 'n_c_d_cases_by_health_region_colum_chart_widget_widget.dart'
    show NCDCasesByHealthRegionColumChartWidgetWidget;
...
class NCDCasesByHealthRegionColumChartWidgetModel
    extends FlutterFlowModel<NCDCasesByHealthRegionColumChartWidgetWidget> {
  ///  Local state fields for this component.

  List<u_i_library_3c2hbt_data_schema.ColumnChartDataStruct> chart = [];
  void addToChart(u_i_library_3c2hbt_data_schema.ColumnChartDataStruct item) =>
      chart.add(item);
  void removeFromChart(
          u_i_library_3c2hbt_data_schema.ColumnChartDataStruct item) =>
      chart.remove(item);
  ...
  void updateChartAtIndex(
          int index,
          Function(u_i_library_3c2hbt_data_schema.ColumnChartDataStruct)
              updateFn) =>
      chart[index] = updateFn(chart[index]);

  List<Color> color = [const Color(0xff08a743), const Color(0xff24b8c2)];
