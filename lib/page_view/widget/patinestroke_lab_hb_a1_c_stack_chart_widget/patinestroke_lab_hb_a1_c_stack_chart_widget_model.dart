...
import 'patinestroke_lab_hb_a1_c_stack_chart_widget_widget.dart'
    show PatinestrokeLabHbA1CStackChartWidgetWidget;
...
class PatinestrokeLabHbA1CStackChartWidgetModel
    extends FlutterFlowModel<PatinestrokeLabHbA1CStackChartWidgetWidget> {
  ...
  List<Color> color = [const Color(0xff2b7fc7), const Color(0xff7e21c8)];
