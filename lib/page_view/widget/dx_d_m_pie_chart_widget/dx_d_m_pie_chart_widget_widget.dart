...
import 'dx_d_m_pie_chart_widget_model.dart';
export 'dx_d_m_pie_chart_widget_model.dart';

class DxDMPieChartWidgetWidget extends StatefulWidget {
  const DxDMPieChartWidgetWidget({super.key});

  @override
  State<DxDMPieChartWidgetWidget> createState() =>
      _DxDMPieChartWidgetWidgetState();
}

class _DxDMPieChartWidgetWidgetState extends State<DxDMPieChartWidgetWidget> {
  late DxDMPieChartWidgetModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DxDMPieChartWidgetModel());
                  ...
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        fit: BoxFit.cover,
                        image: Image.network(
                          'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/n-c-d-dashboad-yr2b5b/assets/ojw4iywodzp7/DM.png',
                        ).image,
                      ),
                    ),
                  ),
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Expanded(
                        child: Text(
                          'กราฟแสดงผู้ป่วยวินิจฉัยโรคเบาหวาน (DM)',
                          maxLines: 1,
                          style:
