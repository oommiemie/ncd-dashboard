...
import 'high_blood14090_donut_widget_widget.dart'
    show HighBlood14090DonutWidgetWidget;
...
class HighBlood14090DonutWidgetModel
    extends FlutterFlowModel<HighBlood14090DonutWidgetWidget> {
  ...
  List<Color> color = [const Color(0xfffebb08), const Color(0xffff6801), const Color(0xffc80b07)];
