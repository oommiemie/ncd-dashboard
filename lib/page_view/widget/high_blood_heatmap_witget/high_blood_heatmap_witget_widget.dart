...
import 'high_blood_heatmap_witget_model.dart';
export 'high_blood_heatmap_witget_model.dart';

class HighBloodHeatmapWitgetWidget extends StatefulWidget {
  const HighBloodHeatmapWitgetWidget({
    super.key,
  ...
  @override
  State<HighBloodHeatmapWitgetWidget> createState() =>
      _HighBloodHeatmapWitgetWidgetState();
}

class _HighBloodHeatmapWitgetWidgetState
    extends State<HighBloodHeatmapWitgetWidget> {
  late HighBloodHeatmapWitgetModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HighBloodHeatmapWitgetModel());
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              widget.title ?? 'กราฟแสดงจำนวนผู้ป่วยโรคความดันโลหิตสูง',
              maxLines: 1,
                                      ...
                                      decoration: BoxDecoration(
                                        color: () {
                                          if (widget.topFirst! <= 500) {
                                            return const Color(0xFFA4E3D3);
                                          } else if (widget.topFirst! <= 2600) {
                                            return const Color(0xFF91D1C8);
                                          } else if (widget.topFirst! <= 5100) {
                                            return const Color(0xFF7EBEBD);
                                          } else if (widget.topFirst! <= 7600) {
                                            return const Color(0xFF6BABB2);
                                          } else if (widget.topFirst! <=
                                              10100) {
                                            return const Color(0xFF5798A6);
                                          } else if (widget.topFirst! <=
                                              12600) {
                                            return const Color(0xFF44859B);
                                          } else if (widget.topFirst! <=
                                              15100) {
                                            return const Color(0xFF44859B);
                                          } else if (widget.topFirst! <=
                                              17600) {
                                            return const Color(0xFF1E6085);
                                          } else if (widget.topFirst! >=
                                              19600) {
                                            return const Color(0xFF0F517C);
