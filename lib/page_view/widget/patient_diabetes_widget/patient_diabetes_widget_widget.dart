...
import 'patient_diabetes_widget_model.dart';
export 'patient_diabetes_widget_model.dart';

class PatientDiabetesWidgetWidget extends StatefulWidget {
  const PatientDiabetesWidgetWidget({super.key});

  @override
  State<PatientDiabetesWidgetWidget> createState() =>
      _PatientDiabetesWidgetWidgetState();
}

class _PatientDiabetesWidgetWidgetState
    extends State<PatientDiabetesWidgetWidget> {
  late PatientDiabetesWidgetModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PatientDiabetesWidgetModel());
          ...
          children: [
            Row(
              ...
              children: [
                Expanded(
                  child: Text(
                    'กราฟแท่งแสดงจำนวนของผู้ป่วยเบาหวาน(ตามเขตสุขภาพ)',
                    maxLines: 1,
            ...
            Expanded(
              child: Container(
                ...
                child: u_i_library_3c2hbt_custom_widgets.ColumnChart(
                  width: double.infinity,
                  height: double.infinity,
                  seriesNames1: 'จำนวนผู้ป่วยเบาหวานทั้งหมด',
                  seriesNames2: 'ผู้ป่วยเบาหวานที่ได้รับการตรวจแล็บ',
                  columnWidth: 0.8,
                  showLabels: true,
                  labelFontSize: 8.0,
                  labelFontColor:
