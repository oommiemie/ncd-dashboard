...
import 'stroke_b_m_i_colum_chart_widget_model.dart';
export 'stroke_b_m_i_colum_chart_widget_model.dart';

class StrokeBMIColumChartWidgetWidget extends StatefulWidget {
  const StrokeBMIColumChartWidgetWidget({super.key});

  @override
  State<StrokeBMIColumChartWidgetWidget> createState() =>
      _StrokeBMIColumChartWidgetWidgetState();
}

class _StrokeBMIColumChartWidgetWidgetState
    extends State<StrokeBMIColumChartWidgetWidget> {
  late StrokeBMIColumChartWidgetModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StrokeBMIColumChartWidgetModel());
            ...
            Expanded(
              child: SizedBox(
                ...
                child: u_i_library_3c2hbt_custom_widgets.ColumnStackedChart(
                  ...
                  max: 5000.0,
                  interval: 1000.0,
                  seriesName1: 'Ischemic stroke (I63)',
                  seriesName2: 'Hemorrhagic stroke (I60-I62 )',
                  seriesName3: 'Stroke (I60-I64)',
                  showLabels: true,
                  labelFontSize: 8.0,
                  labelFontColor:
