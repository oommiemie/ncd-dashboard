...
import 'high_blood_colum_chart_widget_widget.dart'
    show HighBloodColumChartWidgetWidget;
...
class HighBloodColumChartWidgetModel
    extends FlutterFlowModel<HighBloodColumChartWidgetWidget> {
  ...
  List<Color> color = [const Color(0xff24b8c2)];
