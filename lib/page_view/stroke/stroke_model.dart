...
import 'stroke_widget.dart' show StrokeWidget;
import 'package:flutter/material.dart';

class StrokeModel extends FlutterFlowModel<StrokeWidget> {
  ...
  // Model for Stroke_BMIColumChart_Widget component.
  late StrokeBMIColumChartWidgetModel strokeBMIColumChartWidgetModel;
  ...
  // Model for BMIColumChart_Widget component.
  late BMIColumChartWidgetModel bMIColumChartWidgetModel3;
  // Model for Patinestroke_LabHbA1CStackChart_Widget component.
  late PatinestrokeLabHbA1CStackChartWidgetModel
  ...
  void initState(BuildContext context) {
    ...
    strokeBMIColumChartWidgetModel =
        createModel(context, () => StrokeBMIColumChartWidgetModel());
    patinestrokeLabHbA1CStackChartWidgetModel1 =
  ...
  void dispose() {
    ...
    strokeBMIColumChartWidgetModel.dispose();
    ...
    bMIColumChartWidgetModel3.dispose();
