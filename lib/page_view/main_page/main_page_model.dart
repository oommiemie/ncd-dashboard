...
class MainPageModel extends FlutterFlowModel<MainPageWidget> {
  ...
  // Model for card_Widget2 component.
  late CardWidget2Model cardWidget2Model1;
  // Model for card_Widget2 component.
  late CardWidget2Model cardWidget2Model2;
  ...
  // Model for PatientsMissingCareWidget component.
  late PatientsMissingCareWidgetModel patientsMissingCareWidgetModel;
  ...
  void initState(BuildContext context) {
    ...
    cardWidget2Model1 = createModel(context, () => CardWidget2Model());
    cardWidget2Model2 = createModel(context, () => CardWidget2Model());
    patientIncidenceHistogramChartWidgetModel =
    ...
    patientsMissingCareWidgetModel =
        createModel(context, () => PatientsMissingCareWidgetModel());
  ...
  void dispose() {
    ...
    cardWidget2Model1.dispose();
    cardWidget2Model2.dispose();
    ...
    patientsMissingCareWidgetModel.dispose();
