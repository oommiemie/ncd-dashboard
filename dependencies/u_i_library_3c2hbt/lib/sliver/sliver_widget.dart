import '/draft/multiple_section/multiple_section_widget.dart';
...
class _SliverWidgetState extends State<SliverWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SliverModel());
