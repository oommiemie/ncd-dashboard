...
import 'dialog_image_model.dart';
export 'dialog_image_model.dart';
...
class DialogImageWidget extends StatefulWidget {
  ...
  final Widget Function()? illustraion;
  final String title;
...
class _DialogImageWidgetState extends State<DialogImageWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DialogImageModel());
        ...
        child: Column(
          ...
          children: [
            Column(
              ...
              children: [
                Builder(builder: (_) {
                  return widget.illustraion != null
                      ? widget.illustraion!()
                      : SizedBox.shrink();
                }).animateOnPageLoad(
